	  ...
	  <div class="nav-collapse">
		<ul class="nav">
			<li class=""><a href="administrador.php" class="encabezado"><strong>INICIO</strong>
				...
				<li><a href="encuesta/prueba1/index1.php" class="encabezado">Encuestas</a>
					<ul>
...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		...
		<hr class="soft"/>
		<h2 align="center" class="botVot">Candidatos Registrados</h2> 
		<center class = "btn">
		<a class="btn btn2" href="candidato.php">A&ntilde;adir nuevo candidato</a>
		<a class="btn btn2" href="tablaResult.php" >Ir a Resultados</a>
		</center>
...
//la variable  $mysqli viene de conexion que lo traigo con el require("conexion.php");
				...
				echo "<table class='table table-hover';>";
					echo "<tr id = 'new'>";
						...
						echo "<td id = 'fuente'><strong>CODIGO</strong></td>";
						echo "<td id = 'fuente'><strong>NOMBRE</strong></td>";
						echo "<td id = 'fuente'><strong>ROL</strong></td>";
						echo "<td id = 'fuente'><strong>POSTULADO A</strong></td>";
						echo "<td id = 'fuente' width='40'><strong>EDITAR</strong></td>";
						echo "<td id = 'fuente' width='40'><strong>BORRAR</strong></td>";
					echo "</tr>";
			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='info' >";
				    	...
				    	echo "<td id = 'fuente2'>$arreglo[5]</td>";

				    	echo "<td><a href='editarCandidato.php?id=$arreglo[0]'><img src='images/editar2.png' class='img-rounded'></td>";
						echo "<td><a href='tablaVotacion.php?id=$arreglo[0]&idborrar=2'><img src='images/eliminar.PNG' class='img-rounded'/></a></td>";
