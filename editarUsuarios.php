...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->	
		...
		<hr class="soft"/>
		<h2 align="center" class="botVot">Edición de usuarios</h2>
		<hr>
		<div class="row-fluid">
	...
	//la variable  $mysqli viene de conexion que lo traigo con el require("conexion.php");
		...
		<form action="ejecutaactualizar.php" method="post">
			<center>
				...
				<p style="font-family: Courier; font-size: 20px; margin-bottom: 15px "><strong>Usuario</strong><br><input type="text" name="nombre" value="<?php echo $user?>"><br></p>
				<p style="font-family: Courier; font-size: 20px; margin-bottom: 15px "><strong> Cedula</strong><br><input type="text" name="cedula_usuario" value="<?php echo $cedula?>"><br></p> 
				<p style="font-family: Courier; font-size: 20px; margin-bottom: 15px "><strong> Password usuario</strong><br> <input type="text" name="password" value="<?php echo $pass?>"><br></p> 
				<p style="font-family: Courier; font-size: 20px; margin-bottom: 15px "><strong>Correo usuario</strong><br> <input type="text" name="correo" value="<?php echo $email?>"><br></p>
				<p style="font-family: Courier; font-size: 20px; margin-bottom: 15px "><strong> Password administrador</strong><br> <input type="text" name="passadmin" value="<?php echo $pasadmin?>"><br></p> 
