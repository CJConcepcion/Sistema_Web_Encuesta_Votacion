    ...
    display:block;
        ...
        <div class="container">
          <div class="nav-collapse">
            <ul class="nav">
                <li class=""><a href="administrador.php" class="encabezado"><strong>INCIO</strong> </a></li>
        ...
        <!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->    
            ...
            <center class="btn">
                <a href="./graficas/graficaHorizontal.php" class="btn btn2" >VISTA HORIZONTAL</a>
                <a href="./graficas/graficaVertical.php" class="btn btn2">VISTA VERTICAL</a>
                <a href="./graficas/graficaLineal.php" class="btn btn2">VISTA LINEAL</a>
                <a href="tablaResult.php" class="btn btn2">VOLVER</a>
            </center>
            <hr>
        ...
        title: {
            text: 'VISTA GENERAL DE RESULTADOS'
        },
        tooltip: {
