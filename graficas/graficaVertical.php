    ...
    display:block;
        ...
        <!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->   
                ...
                <center class = "btn">
                    ...
                    <a class="btn btn2" href="graficaLineal.php">VISTA LINEAL</a>
        ...
        <script src="../../librerias/highChart/code/modules/drilldown.js"></script>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'VISTA VERTICAL DE RESULTADOS'
    },
    accessibility: {
        announceNewData: {
            enabled: true
    ...
    yAxis: {
        title: {
            text: 'Cantidad de votos obtenidos'
        }
    },
    tooltip: {
        valueSuffix: ''
