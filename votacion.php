...
<header class="header">
<div class="row">
<h1 style="font-family: Courier New; font-size: 60px; text-align: center;">CENTRO DE VOTACIONES</h1>
...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		<div class="well well-small">
			<hr class="soft"/>
			<h2 align="center" class="botVot">M&oacute;dulo De Votaciones</h2>
				<div class="row-fluid">
			<hr>		
				</div>
	<div class="row">
		<div class="span4">
			...
			<a href="candidato.php"><img src="images/nex.png" class="relation"/></a>
					<div class="caption">
						<a href="candidato.php" style="text-align: center; font-family: Arial Narrow;"><h3 style="text-align: center;" style="text-decoration: none">Agregar Nuevos Candidatos</h3></a>
						<br/>
					</div>
			</div>
		</div>
		...
		<div class="span4">
			<div class="thumbnail">
				...
				<a href="tablaVotacion.php"><img src="images/usuarioRegister.png" class="relation"/></a>	
					<div class="caption">
						<a href="tablaVotacion.php" style="text-align: center; font-family: Arial Narrow;"><h3 style="text-align: center;" style="text-decoration: none"> Ver Candidatos Existentes</h3></a>	
						<br/>
					</div>
			</div>
